...
//		assert(Timetable::getInstance()->rules.searchActivityTag(activityTag)>=0);
    ...
    ctr=new ConstraintActivitiesPreferredStartingTimes(TContext::get()->instance, group, weight, /*compulsory,*/ teacher, students, subject, activityTag, duration, n, days_L, hours_L);
