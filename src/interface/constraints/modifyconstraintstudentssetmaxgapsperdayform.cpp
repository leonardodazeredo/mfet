...
ModifyConstraintStudentsSetMaxGapsPerDayForm::ModifyConstraintStudentsSetMaxGapsPerDayForm(QWidget* parent, ConstraintStudentsSetMaxGapsPerDay* ctr): GenericConstraintForm(parent)
{
	setupUi(this);
	...
	maxGapsSpinBox->setMaximum(TContext::get()->instance.nHoursPerDay);
