...
ModifyConstraintTeacherMaxSpanPerDayForm::ModifyConstraintTeacherMaxSpanPerDayForm(QWidget* parent, ConstraintTeacherMaxSpanPerDay* ctr): GenericConstraintForm(parent)
{
	setupUi(this);
