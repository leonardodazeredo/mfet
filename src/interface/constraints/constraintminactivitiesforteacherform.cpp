...
ConstraintMinActivitiesForTeacherForm::ConstraintMinActivitiesForTeacherForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
...
ConstraintMinActivitiesForTeacherForm::~ConstraintMinActivitiesForTeacherForm()
{
	saveFETDialogGeometry(this);
}

bool ConstraintMinActivitiesForTeacherForm::filterOk(TimeConstraint* ctr)
{
    if(ctr->type==CONSTRAINT_MAX_ACTIVITIES_FOR_TEACHER){
        ConstraintMinActivitiesForTeacher* ct=(ConstraintMinActivitiesForTeacher*) ctr;
...
void ConstraintMinActivitiesForTeacherForm::filterChanged()
{
...
void ConstraintMinActivitiesForTeacherForm::constraintChanged(int index)
{
	if(index<0){
...
void ConstraintMinActivitiesForTeacherForm::addConstraint()
{
    AddConstraintMinActivitiesForTeacherForm form(this);
...
void ConstraintMinActivitiesForTeacherForm::modifyConstraint()
{
...
void ConstraintMinActivitiesForTeacherForm::removeConstraint()
{
	int i=constraintsListWidget->currentRow();
	if(i<0){
		QMessageBox::information(this, tr("m-FET information"), tr("Invalid selected constraint"));
