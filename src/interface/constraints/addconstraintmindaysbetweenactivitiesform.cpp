...
void AddConstraintMinDaysBetweenActivitiesForm::addConstraint()
{
    ...
    ctr=new ConstraintMinDaysBetweenActivities(TContext::get()->instance, group, weight, consecutiveIfSameDayCheckBox->isChecked(), this->selectedActivitiesList.count(), ids, minDaysSpinBox->value());
