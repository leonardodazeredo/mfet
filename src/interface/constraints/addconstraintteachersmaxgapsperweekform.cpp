...
AddConstraintTeachersMaxGapsPerWeekForm::AddConstraintTeachersMaxGapsPerWeekForm(QWidget* parent): QDialog(parent)
{
	...
	maxGapsSpinBox->setMaximum(TContext::get()->instance.nDaysPerWeek*TContext::get()->instance.nHoursPerDay);
...
void AddConstraintTeachersMaxGapsPerWeekForm::addCurrentConstraint()
{
    ...
    ctr=new ConstraintTeachersMaxGapsPerWeek(TContext::get()->instance, group, weight, maxGapsSpinBox->value());
