...
//		assert(Timetable::getInstance()->rules.searchActivityTag(activityTag)>=0);
    ...
    ctr=new ConstraintSubactivitiesPreferredTimeSlots(TContext::get()->instance, group, weight, componentNumberSpinBox->value(),/*compulsory,*/ teacher, students, subject, activityTag, n, days_L, hours_L);
