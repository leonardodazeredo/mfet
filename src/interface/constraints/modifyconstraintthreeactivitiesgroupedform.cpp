...
ModifyConstraintThreeActivitiesGroupedForm::ModifyConstraintThreeActivitiesGroupedForm(QWidget* parent, ConstraintThreeActivitiesGrouped* ctr): GenericConstraintForm(parent)
{
	setupUi(this);
...
void ModifyConstraintThreeActivitiesGroupedForm::ok()
{
	...
	assert(tmp4<TContext::get()->instance.activitiesList.size());
