...
ModifyConstraintStudentsMinRestingHoursForm::ModifyConstraintStudentsMinRestingHoursForm(QWidget* parent, ConstraintStudentsMinRestingHours* ctr): GenericConstraintForm(parent)
{
	setupUi(this);
