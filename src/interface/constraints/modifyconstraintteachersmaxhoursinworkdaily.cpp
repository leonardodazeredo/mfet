...
ModifyConstraintTeachersMaxHoursInWorkDailyForm::ModifyConstraintTeachersMaxHoursInWorkDailyForm(QWidget* parent, ConstraintTeachersMaxHoursInWorkDaily* ctr): GenericConstraintForm(parent)
{
	setupUi(this);
...
ModifyConstraintTeachersMaxHoursInWorkDailyForm::~ModifyConstraintTeachersMaxHoursInWorkDailyForm()
{
	saveFETDialogGeometry(this);
}

void ModifyConstraintTeachersMaxHoursInWorkDailyForm::updateMaxHoursSpinBox(){
	maxHoursSpinBox->setMinimum(1);
	maxHoursSpinBox->setMaximum(TContext::get()->instance.nHoursPerDay);	
}

void ModifyConstraintTeachersMaxHoursInWorkDailyForm::constraintChanged()
{
}

void ModifyConstraintTeachersMaxHoursInWorkDailyForm::ok()
{
...
void ModifyConstraintTeachersMaxHoursInWorkDailyForm::cancel()
{
	this->close();
}
