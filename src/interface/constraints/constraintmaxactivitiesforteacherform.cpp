...
#include "addconstraintmaxactivitiesforteacherform.h"
...
ConstraintMaxActivitiesForTeacherForm::ConstraintMaxActivitiesForTeacherForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
...
ConstraintMaxActivitiesForTeacherForm::~ConstraintMaxActivitiesForTeacherForm()
{
	saveFETDialogGeometry(this);
}

bool ConstraintMaxActivitiesForTeacherForm::filterOk(TimeConstraint* ctr)
{
    if(ctr->type==CONSTRAINT_MAX_ACTIVITIES_FOR_TEACHER){
        ConstraintMaxActivitiesForTeacher* ct=(ConstraintMaxActivitiesForTeacher*) ctr;
...
void ConstraintMaxActivitiesForTeacherForm::filterChanged()
{
...
void ConstraintMaxActivitiesForTeacherForm::constraintChanged(int index)
{
	if(index<0){
...
void ConstraintMaxActivitiesForTeacherForm::addConstraint()
{
    AddConstraintMaxActivitiesForTeacherForm form(this);
...
void ConstraintMaxActivitiesForTeacherForm::modifyConstraint()
{
...
void ConstraintMaxActivitiesForTeacherForm::removeConstraint()
{
	int i=constraintsListWidget->currentRow();
	if(i<0){
		QMessageBox::information(this, tr("m-FET information"), tr("Invalid selected constraint"));
