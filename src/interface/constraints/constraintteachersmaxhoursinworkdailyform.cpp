...
ConstraintTeachersMaxHoursInWorkDailyForm::ConstraintTeachersMaxHoursInWorkDailyForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
...
ConstraintTeachersMaxHoursInWorkDailyForm::~ConstraintTeachersMaxHoursInWorkDailyForm()
{
	saveFETDialogGeometry(this);
}

bool ConstraintTeachersMaxHoursInWorkDailyForm::filterOk(TimeConstraint* ctr)
{
    if(ctr->type==CONSTRAINT_TEACHERS_MAX_HOURS_IN_WORK_DAILY)
		return true;
	else
		return false;
}

void ConstraintTeachersMaxHoursInWorkDailyForm::filterChanged()
{
...
void ConstraintTeachersMaxHoursInWorkDailyForm::constraintChanged(int index)
{
	if(index<0){
...
void ConstraintTeachersMaxHoursInWorkDailyForm::addConstraint()
{
    AddConstraintTeachersMaxHoursInWorkDailyForm form(this);
...
void ConstraintTeachersMaxHoursInWorkDailyForm::modifyConstraint()
{
...
void ConstraintTeachersMaxHoursInWorkDailyForm::removeConstraint()
{
	int i=constraintsListWidget->currentRow();
	if(i<0){
		QMessageBox::information(this, tr("m-FET information"), tr("Invalid selected constraint"));
