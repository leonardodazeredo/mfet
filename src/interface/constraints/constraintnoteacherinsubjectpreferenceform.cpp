...
ConstraintNoTeacherInSubjectPreferenceForm::ConstraintNoTeacherInSubjectPreferenceForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
...
ConstraintNoTeacherInSubjectPreferenceForm::~ConstraintNoTeacherInSubjectPreferenceForm()
{
	saveFETDialogGeometry(this);
}

bool ConstraintNoTeacherInSubjectPreferenceForm::filterOk(TimeConstraint* ctr)
{
    if(ctr->type==CONSTRAINT_NO_TEACHER_SUBJECT_PREFERENCE)
        return true;
    else
        return false;
}

void ConstraintNoTeacherInSubjectPreferenceForm::filterChanged()
{
...
void ConstraintNoTeacherInSubjectPreferenceForm::constraintChanged(int index)
{
	if(index<0){
...
void ConstraintNoTeacherInSubjectPreferenceForm::addConstraint()
{
    AddConstraintNoTeacherInSubjectPreferenceForm form(this);
...
void ConstraintNoTeacherInSubjectPreferenceForm::modifyConstraint()
{
...
void ConstraintNoTeacherInSubjectPreferenceForm::removeConstraint()
{
	int i=constraintsListWidget->currentRow();
	if(i<0){
		QMessageBox::information(this, tr("m-FET information"), tr("Invalid selected constraint"));
