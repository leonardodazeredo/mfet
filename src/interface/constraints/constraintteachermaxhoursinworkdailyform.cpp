...
#include "addconstraintteachermaxhoursinworkdailyform.h"
...
ConstraintTeacherMaxHoursInWorkDailyForm::ConstraintTeacherMaxHoursInWorkDailyForm(QWidget* parent): QDialog(parent)
{
	setupUi(this);
...
ConstraintTeacherMaxHoursInWorkDailyForm::~ConstraintTeacherMaxHoursInWorkDailyForm()
{
	saveFETDialogGeometry(this);
}

bool ConstraintTeacherMaxHoursInWorkDailyForm::filterOk(TimeConstraint* ctr)
{
    if(ctr->type==CONSTRAINT_TEACHER_MAX_HOURS_IN_WORK_DAILY){
        ConstraintTeacherMaxHoursInWorkDaily* ct=(ConstraintTeacherMaxHoursInWorkDaily*) ctr;
...
void ConstraintTeacherMaxHoursInWorkDailyForm::filterChanged()
{
...
void ConstraintTeacherMaxHoursInWorkDailyForm::constraintChanged(int index)
{
	if(index<0){
...
void ConstraintTeacherMaxHoursInWorkDailyForm::addConstraint()
{
    AddConstraintTeacherMaxHoursInWorkDailyForm form(this);
...
void ConstraintTeacherMaxHoursInWorkDailyForm::modifyConstraint()
{
...
void ConstraintTeacherMaxHoursInWorkDailyForm::removeConstraint()
{
	int i=constraintsListWidget->currentRow();
	if(i<0){
		QMessageBox::information(this, tr("m-FET information"), tr("Invalid selected constraint"));
