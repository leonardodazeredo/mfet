...
ModifyConstraintTeachersMinRestingHoursForm::ModifyConstraintTeachersMinRestingHoursForm(QWidget* parent, ConstraintTeachersMinRestingHours* ctr): GenericConstraintForm(parent)
{
	setupUi(this);
