...
ModifyConstraintMinGapsBetweenActivitiesForm::ModifyConstraintMinGapsBetweenActivitiesForm(QWidget* parent, ConstraintMinGapsBetweenActivities* ctr): GenericConstraintForm(parent)
{
	setupUi(this);
	...
	minGapsSpinBox->setMaximum(TContext::get()->instance.nHoursPerDay);
